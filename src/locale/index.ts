const i18n = {
  ...
  'zh-CN': {
    ...
    'menu.algorithmConfig': '调度算法配置',
    'menu.algorithmConfig.schedulingConfig': '调度配置',
    'menu.jobScheduling': '工序作业排产',
    'menu.jobScheduling.schedulingResult':'调度结果',
    'menu.jobScheduling.planningSimulation':'计划仿真',
    'menu.realTimeProductionTracking': '实时生产跟踪',
    'menu.realTimeProductionTracking.productionTracking': '生产跟踪',
    'menu.realTimeProductionTracking.eventStatistic': '事件统计',
